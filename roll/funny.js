...
let rplyArr = ['\
「這波輸出完掛著就沒我的事情了」', '\
「我這一發下去就搞定了 只要不被爆特動就穩了」', '\
「這塔我們已經爬那麼多次了，聖晶石可以不用帶了吧？」', '\
「這回合結束，遊戲也結束了。」', '\
「隊友！幫我撐10秒。」', '\
「打這隻怪就跟喝水一樣簡單」', '\
「宅在永望島便可拯救世界」', '\
...
「身體好輕」', '\
「我不會讓任何人死的。」', '\
「不管你是誰，這就是我的最終奧義。這一招我只會演示一次，你看好了！」', '\
「從來沒有人能逃過我艾許的星爆氣流斬。」', '\
「告訴你吧賽貝羅絲，我現在手上拿著的 可是鬼牌呢。」', '\
「嗨，賽姊。 下次見，賽姊。」', '\
「我們的策略已經完美到毫無破綻啦」'];
...
let rplyArr = ['\
比起在這裡跟我閒話家常，你不是還有老婆跟世界要救嗎?', '\
這位玩家，你今天看起來有點不幸呢。 \n（幫你點開記憶隙間）', '\
白:喵~', '\
……?', '\
這位客人，怎麼了嗎?', '\
我又不是科學家，想不起神器使的記憶? 我只建議你課金。', '\
今天的天氣真好呢，對吧？。', '\
看來你又想起了新的東西呢。', '\
讓我猜猜，你這周目又炸了? 還是你其實很喜歡箱庭或滅世結局', '\
放輕鬆點，來喝杯下午茶吧', '\
怎麼了嗎？我正在看書呢', '\
作為一名記憶觀測者，還真不容易呢', '\
我在吃吉拿棒呢，你也要一起吃嗎？', '\
