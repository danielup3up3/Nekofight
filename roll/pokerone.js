...
////////////////抽卡數
    ...
    //確定遊戲階段
		...
		if(pokercard == '單張'){
			...
			Rulistdiamond = ['7','2','3','4','5','6','7','8','9','10','7','J','Q'];
			
			Rulistheart.length = 13;
			Rulistheart = ['7','2','3','4','5','6','7','8','9','10','7','J','7'];
			
			Rulistspade.length = 13;
			Rulistspade = ['7','2','3','4','5','6','7','8','9','10','7','Q','K'];
      
      Rulistclubs.length = 13;
			Rulistclubs = ['7','2','3','4','5','6','7','8','9','10','7','J','K'];
      ...
      RulistJOKER.length = 1;
			...
			//設定獎勵內容
			Rulistdiamond.length = 13;
			Rulistdiamond = ['7','2','3','4','5','6','7','8','9','10','7','7','7'];
			
			Rulistheart.length = 13;
			Rulistheart = ['7','2','3','4','5','6','7','8','9','10','7','7','7'];
			
			Rulistspade.length = 13;
			Rulistspade = ['7','2','3','4','5','6','7','8','9','10','7','7','7'];
      
                        Rulistclubs.length = 13;
			Rulistclubs = ['7','2','3','4','5','6','7','8','9','10','7','7','7'];
